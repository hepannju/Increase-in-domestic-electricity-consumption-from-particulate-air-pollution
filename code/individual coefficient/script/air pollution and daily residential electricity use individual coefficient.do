...
ivreg2 consum (v_PM10_mean=wind_cos) v_Ozone_max8hour cdd_new hdd_new prcp wdsp rhmd stormevent lnprice i.year i.month weekend holiday

statsby b_v_PM25_mean=_b[v_PM25_mean] se_v_PM25_mean=_se[v_PM25_mean], by(vmatchbk) nodots saving(residents_PM25.dta) : ///
ivreg2 consum (v_PM25_mean=wind_cos) v_Ozone_max8hour cdd_new hdd_new prcp wdsp rhmd stormevent lnprice i.year i.month weekend holiday
