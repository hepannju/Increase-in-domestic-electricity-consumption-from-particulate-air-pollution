...
capture log close
set more off
global path "E:\sand storm\storm\dofile\individual coefficient\data\"
cd "E:\sand storm\storm\dofile\individual coefficient\data\"
...
capture rm "commercial_PM10.dta"
capture rm "commercial_PM25.dta"

**********************main analysis
statsby b_v_PM10_mean=_b[v_PM10_mean] se_v_PM10_mean=_se[v_PM10_mean], by(vmatchbk) nodots saving(commercial_PM10.dta) : ///
ivreg2 consum (v_PM10_mean=wind_cos) v_Ozone_max8hour cdd_new hdd_new prcp wdsp rhmd stormevent lndcharge lnecharge i.year i.month weekend holiday

statsby b_v_PM25_mean=_b[v_PM25_mean] se_v_PM25_mean=_se[v_PM25_mean], by(vmatchbk) nodots saving(commercial_PM25.dta) : ///
ivreg2 consum (v_PM25_mean=wind_cos) v_Ozone_max8hour cdd_new hdd_new prcp wdsp rhmd stormevent lndcharge lnecharge i.year i.month weekend holiday
