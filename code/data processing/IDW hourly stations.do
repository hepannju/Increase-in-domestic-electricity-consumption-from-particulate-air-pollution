cd "E:\sand storm\data\data\air quality and climate hourly"

clear

use "air quality and climate hourly.dta", clear

keep parametername latitude longitude datum

duplicates drop latitude longitude, force

cd "E:\sand storm\data\data"

save "hourly data station.dta", replace
