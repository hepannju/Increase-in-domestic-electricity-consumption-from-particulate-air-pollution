...
ggsave("figure 2.pdf", residential, width = 16.2, height=10, units="in", dpi=900)
...
ggsave("figure 4.pdf", commercial, width = 16.2, height=10, units="in", dpi=900)
...
ggsave("figure 1.pdf", residential_hourly_analysis, width = 16.2, height=10, units="in", dpi=900)
...
ggsave("figure 3.pdf", commercial_hourly_analysis, width = 16.2, height=10, units="in", dpi=900)



###################residential, statsby (figure S1)
